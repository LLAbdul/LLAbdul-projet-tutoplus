...
CREATE TABLE IF NOT EXISTS disponibilites (
    ...
    etudiant_id CHAR(36) NULL COMMENT 'UUID de l\'étudiant qui a réservé (NULL si non réservé)',
    ...
    FOREIGN KEY (etudiant_id) REFERENCES etudiants(id) ON DELETE SET NULL ON UPDATE CASCADE,
    INDEX idx_tuteur (tuteur_id),
